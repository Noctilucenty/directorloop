...
for(const f of ['../public/evidence.json','../src/App.tsx']){const text=fs.readFileSync(new URL(f,import.meta.url),'utf8');assert.ok(!/\/Users\/|api[_-]?key|Bearer |sk-proj-|wandb_v1_|127\.0\.0\.1/.test(text));}
